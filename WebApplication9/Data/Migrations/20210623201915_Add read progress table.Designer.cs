...
namespace WebApplication9.Data.Migrations
{
    ...
    [Migration("20210623201915_Add read progress table")]
    partial class Addreadprogresstable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookUserLibrary", b =>
                {
                    b.Property<Guid>("BooksId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("UsersLibrariesId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("BooksId", "UsersLibrariesId");

                    b.HasIndex("UsersLibrariesId");

                    b.ToTable("BookUserLibrary");
                });
            ...
            modelBuilder.Entity("WebApplication9.Data.Models.Book", b =>
                {
                    ...
                    b.Property<string>("PublishedDay")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    ...
                    b.HasOne("WebApplication9.Data.Models.Book", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookGenre", b =>
                {
                    ...
                    b.HasOne("WebApplication9.Data.Models.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookUserLibrary", b =>
                {
                    ...
                    b.HasOne("WebApplication9.Data.Models.UserLibrary", null)
                        .WithMany()
                        .HasForeignKey("UsersLibrariesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
